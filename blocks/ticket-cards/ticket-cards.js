...
// Mark the first <em> in the content as the price label
const firstEmP = contentCell.querySelector('p > em');
if (firstEmP && firstEmP.parentElement.children.length === 1) {
firstEmP.parentElement.classList.add('ticket-cards-label');
}
